...
# ─────────────────────────────────────────────────────────────────────────
# 행정구 (district) — 25개 모든 서울 구
# ─────────────────────────────────────────────────────────────────────────

DISTRICTS = [
    {
        "slug": "gangnam-gu", "name": "강남구",
        "focus": "업무지구와 오피스텔 중심 재정자립도 높은 구",
        ...
        "dongs": ["역삼동", "삼성동", "청담동", "논현동", "대치동", "압구정동"],
    },
    {
        "slug": "gangdong-gu", "name": "강동구",
        "focus": "주거와 상권, 광진지구 개발 중심",
        "intro": "강동구는 강일동·암사동의 강동지구와 성내동·광진동을 포함하는 광진지구로 나뉩니다. 대규모 주거 단지와 상권이 발전하면서 가족 단위 방문과 오피스텔 방문이 증가하고 있습니다.",
        "dongs": ["성내동", "강일동", "암사동", "광진동"],
    },
    {
        "slug": "gangbuk-gu", "name": "강북구",
        "focus": "북부 주거 생활권과 의료·교육 중심",
        "intro": "강북구는 삼양동·수유동·인수동으로 이어지는 북부 주거 지역입니다. 북한산 인근 자연을 활용한 주거 환경과 함께 의료·교육 기반이 갖춰진 지역으로, 주거 방문이 중심입니다.",
        "dongs": ["삼양동", "수유동", "인수동", "미아동"],
    },
    {
        "slug": "gangseo-gu", "name": "강서구",
        "focus": "강변 개발과 주거, 허브산업 중심",
        "intro": "강서구는 마곡동·발산동·방화동·화곡동으로 구성된 광역개발 지역입니다. 한강변 마곡지구 개발과 함께 신주거 단지가 증가하면서 방문 가능 지역이 확대되고 있습니다.",
        "dongs": ["마곡동", "발산동", "방화동", "화곡동"],
    },
    {
        "slug": "gwanak-gu", "name": "관악구",
        "focus": "학생 주거와 대학가 상권 중심",
        "intro": "관악구는 서울대학교 캠퍼스와 신림동·봉천동 대학가가 중심인 지역입니다. 학생 단기 거주와 대학가 상권 방문이 특징이며, 주거 밀도가 높은 편입니다.",
        "dongs": ["신림동", "봉천동", "관악동", "난곡동"],
    },
    {
        "slug": "gwangjin-gu", "name": "광진구",
        "focus": "중곡동 개발과 능동, 자양동 주거 중심",
        "intro": "광진구는 중곡동·능동·자양동·구의동으로 이어지는 동부 지역입니다. 한강변과 청계천 인근 오피스텔 개발과 함께 주거 단지가 증가하면서 방문 가능 지역이 넓어지고 있습니다.",
        "dongs": ["중곡동", "능동", "자양동", "구의동"],
    },
    {
        "slug": "guro-gu", "name": "구로구",
        "focus": "구로디지털단지와 신도림 상업 중심",
        "intro": "구로구는 구로디지털단지·신도림역 일대 오피스와 온수동·구로동 주거가 섞인 지역입니다. 업무 방문과 주거 방문이 모두 이루어지며, 야간 건물 출입 확인이 중요합니다.",
        "dongs": ["구로동", "온수동", "신도림동", "항동"],
    },
    {
        "slug": "geumcheon-gu", "name": "금천구",
        "focus": "가산디지털단지와 시흥동 주거·상권 중심",
        "intro": "금천구는 가산디지털단지·시흥동을 포함하는 남부 산업 지역입니다. 오피스 방문이 증가하고 있으며, 주거 밀집도 함께 높아 종합적인 방문 환경을 갖추고 있습니다.",
        "dongs": ["가산동", "시흥동", "독산동"],
    },
    {
        "slug": "nowon-gu", "name": "노원구",
        "focus": "대규모 주거 단지와 생활권 밀집",
        "intro": "노원구는 상계동·중계동·하계동 대단지 주거와 수유동·월계동을 포함하는 광역 주거 지역입니다. 아파트 밀집도가 높아 공동현관 출입과 주차 확인이 주요 사항입니다.",
        "dongs": ["상계동", "중계동", "하계동", "월계동"],
    },
    {
        "slug": "dobong-gu", "name": "도봉구",
        "focus": "북부 주거와 자연환경 중심",
        "intro": "도봉구는 방학동·도봉동·창동으로 이어지는 북부 주거 지역입니다. 도봉산 인근 자연 환경과 함께 주거 밀도가 높으며, 외곽 구간으로 이동비 확인이 필요합니다.",
        "dongs": ["방학동", "도봉동", "창동"],
    },
    {
        "slug": "dongdaemun-gu", "name": "동대문구",
        "focus": "의류 상권과 청량리 역세권 중심",
        "intro": "동대문구는 청량리동·제기동·답십리동·신설동으로 구성되며, 의류 도매상권과 동대문역·청량리역 역세권이 특징입니다. 상권 방문과 역세권 호텔·오피스텔 방문이 이루어집니다.",
        "dongs": ["청량리동", "제기동", "답십리동", "신설동"],
    },
    {
        "slug": "dongjak-gu", "name": "동작구",
        "focus": "노량진 학원가와 주거 중심",
        "intro": "동작구는 노량진동·흑석동·대방동·사당동으로 이루어진 지역입니다. 노량진 학원가와 사당역 상권, 한강변 주거가 섞여 있어 학생·직장인·가족 방문이 모두 이루어집니다.",
        "dongs": ["노량진동", "흑석동", "대방동", "사당동"],
    },
    {
        "slug": "mapo-gu", "name": "마포구",
        "focus": "홍대·합정 상권과 공덕 오피스 중심",
        "intro": "마포구는 홍대·합정·연남·망원 상권과 공덕 오피스, 여의도 금융가 구간을 포함합니다. 숙소와 상권 방문이 많은 서편과 오피스 방문이 많은 공덕으로 성격이 나뉩니다.",
        "dongs": ["서교동", "연남동", "합정동", "망원동", "공덕동"],
    },
    {
        "slug": "seodaemun-gu", "name": "서대문구",
        "focus": "신촌·대현동 대학가 상권 중심",
        "intro": "서대문구는 신촌동·대현동·충현동·북아현동으로 이루어진 대학가 중심 지역입니다. 이화여대·연세대 캠퍼스와 신촌역 상권이 발달해 있으며, 학생 단기 거주 방문이 많습니다.",
        "dongs": ["신촌동", "대현동", "충현동", "북아현동"],
    },
    {
    ...
    },
    {
        ...
        "focus": "성북동 문화·예술 지구와 주거 중심",
        "intro": "성북구는 성북동·길음동·석관동·삼선동으로 구성되며, 성북동 문화·예술 지구와 한성대·성신여대 캠퍼스를 포함합니다. 주거 밀도가 높으며, 예술인·학생 거주가 특징입니다.",
        "dongs": ["성북동", "길음동", "석관동", "삼선동"],
    },
    {
    ...
    },
    {
        ...
        "focus": "은평 뉴타운과 주거 중심",
        "intro": "은평구는 불광동·응암동·역촌동·녹번동으로 이루어진 북서부 주거 지역입니다. 은평 뉴타운 개발로 대규모 아파트 단지가 조성되어 있으며, 주거 방문이 중심입니다.",
        "dongs": ["불광동", "응암동", "역촌동", "녹번동"],
    },
    {
        "slug": "jongno-gu", "name": "종로구",
        "focus": "종로 상권과 서울 역사문화 중심",
        "intro": "종로구는 경복궁동·종로1가동·종로3가동·종로4가동으로 구성되며, 종로 의류 상권과 서울 역사문화 유산이 집중되어 있습니다. 상권 방문과 역사지구 관광객 방문이 함께 이루어집니다.",
        "dongs": ["경복궁동", "종로1가동", "종로3가동", "종로4가동"],
    },
    {
        "slug": "jung-gu", "name": "중구",
        "focus": "명동 상권과 서울역 업무지구 중심",
        "intro": "중구는 명동·을지로동·다동·중림동으로 이루어진 서울 중심 지역입니다. 명동 관광 상권, 서울역·정동 업무지구, 한강변 호텔이 집중되어 있어 관광객과 출장객 방문이 많습니다.",
        "dongs": ["명동", "을지로동", "다동", "중림동"],
    },
    {
        "slug": "jungnang-gu", "name": "중랑구",
        "focus": "중랑·면목·망우동 주거 중심",
        "intro": "중랑구는 중랑동·면목동·망우동·신내동으로 구성된 동부 주거 지역입니다. 대규모 아파트 단지와 상가 시설이 발달해 있으며, 가족 단위 주거 방문이 중심입니다.",
        "dongs": ["중랑동", "면목동", "망우동", "신내동"],
    },
    {
        "slug": "yangcheon-gu", "name": "양천구",
        "focus": "목동 대단지와 주거·교육 중심",
        "intro": "양천구는 목동·신정동·신월동으로 이루어진 서부 주거 지역입니다. 목동 대단지 아파트와 학원가, 신정·오목교 상권이 중심이며, 가족 단위 거주가 많습니다.",
        "dongs": ["목동", "신정동", "신월동"],
    },
]
...
def build_district_pages():
    ...
    for d in DISTRICTS:
        ...
        body += (
            ...
            "<p>아래 행정동들에서 방문이 가능하며, 각 동별 상세 안내는 링크를 참고하세요.</p>"
            + _links([(d_name, f"/district/{d['slug']}/{d_name.replace(' ', '-').lower()}/") for d_name in d["dongs"]])
            + "</section>"
        )
        body += (
            "<section><h2>이용 장소별 확인사항</h2>"
